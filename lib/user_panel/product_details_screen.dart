...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
            ...
            children: [
              ...
              CarouselSlider(
                ...
                options: CarouselOptions(
                  height: Get.height / 2,//image size
                  ...
                  onPageChanged: (index, reason) {
                    setState(() {
                      _currentImageIndex = index; // Update dots
                    });
                  },
                ),
              ),

              // --- DOTS INDICATOR (Visual Array Index) ---
              Row(
  ...
  static Future<void> sendMessageOnWhatsApp({
    ...
    final number = " ";
    final message =
        "I want to buy: ${productModel.productName}\nID: ${productModel.productId}";
